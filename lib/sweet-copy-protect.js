...
;(function(window, document, undefined) {
	...
	/* 
	 * Global Variable scop and sweetCopyProtect
	 */
	var scop, sweetCopyProtect;
	sweetCopyProtect = scop = function(params){
		config(params);
		init();
	}

	/*
	 * defining scop and sweetCopyProtect function to window
	 */
    if (typeof define === 'function' && define.amd) {
      define(function() { return sweetCopyProtect; });
    } else if (typeof module !== 'undefined' && module.exports) {
      module.exports = sweetCopyProtect;
    } else if (typeof window !== 'undefined') {
      window.sweetCopyProtect = window.scop = sweetCopyProtect;
    }
})(window, document);